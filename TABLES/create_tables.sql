...
risultato TEXT,
data DATE NOT NULL,
FOREIGN KEY (idSquadra1) REFERENCES SQUADRA(idSquadra) ON DELETE CASCADE,
FOREIGN KEY (idSquadra2) REFERENCES SQUADRA(idSquadra) ON DELETE CASCADE,
FOREIGN KEY (idStadio) REFERENCES STADIO(idStadio) ON DELETE CASCADE
);